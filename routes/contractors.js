...
router.get('/all',authenticateAndAuthorize([1,3]), controller.viewContractors);
router.get('/add',authenticateAndAuthorize([1,3]), controller.showAddContractor);
router.post('/add',authenticateAndAuthorize([1,3]), controller.createContractor);
